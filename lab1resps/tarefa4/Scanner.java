...
public class Scanner {
	...
	static {
		...
		for (int i = 33; i <= 34; ++i) start.set(i, 2);
		for (int i = 39; i <= 39; ++i) start.set(i, 2);
		for (int i = 44; i <= 46; ++i) start.set(i, 2);
		for (int i = 58; i <= 58; ++i) start.set(i, 2);
		for (int i = 63; i <= 63; ++i) start.set(i, 2);
		for (int i = 66; i <= 66; ++i) start.set(i, 2);
		for (int i = 69; i <= 69; ++i) start.set(i, 2);
		for (int i = 72; i <= 90; ++i) start.set(i, 2);
		...
		literals.put("C", new Integer(3));
		literals.put("Db", new Integer(5));
		literals.put("D", new Integer(6));
		literals.put("Eb", new Integer(8));
		literals.put("E", new Integer(9));
		literals.put("F", new Integer(10));
		literals.put("Gb", new Integer(12));
		literals.put("G", new Integer(13));
		literals.put("Ab", new Integer(15));
		literals.put("A", new Integer(16));
		literals.put("Bb", new Integer(18));
		literals.put("B", new Integer(19));
		...
		loop: for (;;) {
			switch (state) {
				...
				case 2:
					...
					if (ch >= '!' && ch <= '"' || ch == 39 || ch >= ',' && ch <= '.' || ch == ':' || ch == '?' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'z') {AddCh(); state = 2; break;}
