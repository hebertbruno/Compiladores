...
public class Scanner {
	...
	static {
		...
		literals.put("void", new Integer(6));
		literals.put("int", new Integer(11));
		literals.put("bool", new Integer(12));
		literals.put("for", new Integer(16));
		literals.put("in", new Integer(17));
		literals.put("if", new Integer(19));
		literals.put("elif", new Integer(20));
		literals.put("else", new Integer(21));
		literals.put("while", new Integer(22));
		literals.put("do", new Integer(23));
		literals.put("read", new Integer(24));
		literals.put("write", new Integer(25));
		literals.put("break", new Integer(26));
		literals.put("continue", new Integer(27));
		...
		loop: for (;;) {
			switch (state) {
				...
				case 5:
					...
					if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'z') {AddCh(); state = 5; break;}
