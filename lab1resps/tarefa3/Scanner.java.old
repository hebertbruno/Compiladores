...
public class Scanner {
	...
	static {
		...
		literals.put("Sobrenome", new Integer(4));
		literals.put("Pais", new Integer(6));
		literals.put("Filhos", new Integer(8));
		literals.put("Avos", new Integer(9));
		literals.put("Netos", new Integer(10));
		literals.put("Outros", new Integer(11));
		...
		loop: for (;;) {
			switch (state) {
				...
				case 2:
					...
					if (ch == 39 || ch == '-' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'z') {AddCh(); state = 2; break;}
					else {t.kind = 2; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 3:
					recEnd = pos; recKind = 3;
					if (ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'z') {AddCh(); state = 3; break;}
				...
				case 7:
					if (ch == 'a') {AddCh(); state = 8; break;}
					else {state = 0; break;}
				case 8:
					if (ch == 'l') {AddCh(); state = 9; break;}
					else {state = 0; break;}
				case 9:
					if (ch == 'e') {AddCh(); state = 10; break;}
					else {state = 0; break;}
				case 10:
					if (ch == 'c') {AddCh(); state = 11; break;}
					else {state = 0; break;}
				case 11:
					if (ch == 'i') {AddCh(); state = 12; break;}
					else {state = 0; break;}
				case 12:
					if (ch == 'd') {AddCh(); state = 13; break;}
					else {state = 0; break;}
				case 13:
